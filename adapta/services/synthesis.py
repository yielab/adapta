...
from adapta.domain.errors import InternalError, InvalidRequest
...
async def synthesize_from_project(
    ...
    from adapta.services.rag import _get_chroma_client, collection_name_for
    ...
    from adapta.config import settings as _settings
